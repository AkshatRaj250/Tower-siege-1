...
function setup() {
  ...
  slingShot = new SlingShot(this.lol,{x:100,y:200})
...
function mouseDragged(){
  ...
  Matter.Body.setPosition(this.lol, {x: mouseX , y: mouseY});
...
function keyPressed() {
	...
	if(keyCode === 32) {
		Matter.Body.setPosition(this.lol, {x:85, y:200})
		slingShot.attach(this.lol);
  }
